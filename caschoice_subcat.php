...
<?php
	...
	if($_REQUEST["submitbutt"] == "Submit" && $_SESSION["depth"] >= 1)
	{
...
<body>
<form name="choiceques_subcategory" method="post" action="caschoice_subcat.php" onsubmit="return validation();">
<div id="header">
